 ...
 * @author kenda
 */
public class jmIngresar extends javax.swing.JFrame {

    /**
     * Creates new form jmIngresar
     */
    public jmIngresar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btAgregar.setForeground(new java.awt.Color(0, 102, 102));
        btAgregar.setText("Insertar Estudiante");
    ...
    private void btAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAgregarActionPerformed
     ...
     String idEstudiante = txtId.getText();
     String nombreEstudiante = txtNombre.getText();
     String años = txtAños.getText();
     String genero = txtGenero.getText();
     
     met.InsercionEstudiantes(idEstudiante, nombreEstudiante, años, genero);
...
new jmPrincipal().setVisible(true); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jmIngresar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jmIngresar().setVisible(true);
            }
        });
    }
